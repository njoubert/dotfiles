### 2019-04-07 Added by Niels Joubert
# Auto-convert python notebooks to html on save for easy sharing. 
...
def post_save(model, os_path, contents_manager):
    ...
    # uncomment if you want .py files:
